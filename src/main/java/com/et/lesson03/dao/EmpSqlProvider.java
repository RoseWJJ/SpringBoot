...
public class EmpSqlProvider {
     ...
     * This method corresponds to the database table emp
     *
     * @mbg.generated Wed Dec 13 15:20:32 CST 2017
     */
    ...
    protected void applyWhere(SQL sql, EmpExample example, boolean includeExamplePhrase) {
        ...
        List<com.et.lesson03.entity.EmpExample.Criteria> oredCriteria = example.getOredCriteria();
        boolean firstCriteria = true;
        for (int i = 0; i < oredCriteria.size(); i++) {
            com.et.lesson03.entity.EmpExample.Criteria criteria = oredCriteria.get(i);
            if (criteria.isValid()) {
                if (firstCriteria) {
                    firstCriteria = false;
                } else {
                ...
                sb.append('(');
                List<com.et.lesson03.entity.EmpExample.Criterion> criterions = (List<com.et.lesson03.entity.EmpExample.Criterion>) criteria.getAllCriteria();
                boolean firstCriterion = true;
                for (int j = 0; j < criterions.size(); j++) {
                    com.et.lesson03.entity.EmpExample.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
